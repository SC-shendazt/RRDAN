...
to_ascii = False
file_path = '/media/zt/D/3060/KPConv-2-master/Data/Dales_ply/test_ORI'
file_path_2='/media/zt/D/3060/KPConv-2-master/Data/BIN_test'
...
for each_file in files:
    ...
    data1.write(path.join(file_path_2, each_file) )
    print('\n completed.. ', each_file)
    data2 = PlyData.read(path.join(file_path_2, each_file) )
