...
# My libs
from datasets.DFC3D import DFC3DDataset
...
def experiment_name_1():
    ...
    start = 'Log_2023-05-05_07-32-50'
    end = 'Log_2024-05-05_07-32-50'
...
def experiment_name_2():
    ...
    # Using the dates of the logs, you can easily gather consecutive ones. All logs should be of the same dataset.
    start = 'Log_2022-06-29_09-23-27'
    end = 'Log_2023-05-30_04-34-01'
    ...
    logs = np.insert(logs, 0, 'results/Log_2022-05-30_04-34-01')
...
if __name__ == '__main__':
    ...
    if config.dataset_task == 'classification':
        ...
        if config.dataset.startswith('S3DIS'):
            ...
            dataset = DFC3DDataset(config, load_data=False)
            compare_convergences_segment(dataset, logs, logs_names)
