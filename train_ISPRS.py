...
class ISPRSConfig(Config):
    ...
    first_subsampling_dl = 0.45#lasdu
    #unlabel_points
    ...
    learning_rate = 1e-3
    momentum = 0.98
    lr_decays = {i: 0.95 for i in range(1, max_epoch)}  # lasdu
    # lr_decays = {i: 0.8 for i in range(1, max_epoch)}#isprs
    ...
    checkpoint_gap = 1
    # class_w =[5, 1, 1, 1, 3, 1, 1, 5, 1]
    # class_w = [47.71949391, 3.80170852, 3.73349653, 36.97590369, 27.37864491, 4.04994131,
    #            18.55043921, 12.40989437, 5.45897473]
    # Augmentations
