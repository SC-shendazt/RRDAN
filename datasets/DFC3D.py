...
random_validatidon=list(np.random.choice(110, 10, replace=False))
class DFC3DDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        #                        1: 'Low vegetation',
        #                        2: 'surface',
        #                        3: 'Car',  # pole - road sign - traffic light
        #                        4: 'Fence',  # bollard - small pole
        #                        5: 'Roof',  # trash can
        #                        6: 'Facade',
        #                        7: 'shurb',
        #                        8: 'Tree'
        #                        }
        # self.label_to_names = {0: 'C00',
        #                        1: 'C01',
        #                        2: 'C02',
        #                        3: 'C03',
        #                        4: 'C04',
        ...
        # self.cloud_names = ['1Mar18_train - Cloud - Cloud',
        #                     '2Mar18_val - Cloud - Cloud',
        #                     '3Mar18_test - Cloud - Cloud']
        # self.all_splits = [0, 1, 2]
        # self.validation_split = 1
        # self.test_cloud_names = ['3Mar18_test - Cloud - Cloud']
        # self.test_splits = [2]
        # self.train_splits = [0]
        ...
        #                     '5155_54335',
        #                     '5175_54395']
        # self.all_splits = [i for i in range(40)]
        # self.validation_split = ''
        # self.test_cloud_names = ['5080_54400',
        #                          '5080_54470',
        #                          '5100_54440',
        #                          '5100_54490',
        #                          '5120_54445',
        ...
        c=np.sort([f for f in os.listdir(join(self.path,self.original_ply_path))])
        cloud_names=[]
        for i in c:
            name=i.split('_')[0]+'_'+i.split('_')[1]+'_'+'PC3'
            cloud_names.append(name)
        self.cloud_names =cloud_names
        # self.test_cloud_names = ['JAX_004_PC3',
        #                         'JAX_017_PC3',
        #                         'JAX_018_PC3',
        #                         'JAX_020_PC3',
        #                         'JAX_022_PC3',
        ...
        #                         'JAX_068_PC3',
        #                         'JAX_070_PC3']
        self.test_cloud_names = []
        # self.validation_split = list(np.random.choice(110, 10, replace=False))
        self.all_splits = [i for i in range(110)]
        # self.validation_split = [1,2,3,4,6,8,9,12,23,34]
        self.validation_split=[48,82,53,29,28,27,25,24,23,30]
        # self.validation_split = [44, 51, 53, 29, 28, 27, 25, 24, 23, 67]
        # self.validation_split = list(np.random.choice(110, 10, replace=False))
        # self.validation_split=random_validatidon
        self.test_splits = []
        self.train_splits = []
    ...
    def prepare_NPM3D_ply(self):
        ...
        if not exists(ply_path):
            makedirs(ply_path)
        original_ply_path = join(self.path, self.original_ply_path)
        if not exists(original_ply_path):
            makedirs(original_ply_path)
...
class DFC3DSampler(Sampler):
    """Sampler for NPM3D"""

    def __init__(self, dataset: DFC3DDataset):
...
def DFC3DCollate(batch_data):
    return DFC3DCustomBatch(batch_data)
